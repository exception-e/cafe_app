...
import ru.cafe_app.model.Vote;
import ru.cafe_app.repository.VoteDataRepository;
import ru.cafe_app.to.VoteTo;
import ru.cafe_app.util.SecurityUtil;
import ru.cafe_app.util.exception.IllegalRequestDataException;
